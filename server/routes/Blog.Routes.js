...
const {createBlog,getBlogs,getBlogById,updateBlog,deleteBlog,searchBlog,addToFavourites,removefromfavourites,getFavourites} = require('../controllers/Blog.Controller');
